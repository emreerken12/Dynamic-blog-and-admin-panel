...
<!-- Mirrored from thenewtheme.websitefabrikasi.com.tr/h/kurumsal-hizmetimiz-1-8408 by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 10 Nov 2022 17:31:10 GMT -->
...
<meta name="description" content="Kurumsal Hizmetimiz " /><meta name="keywords" content="Kurumsal Hizmetimiz 1" /></head>
...
// Veriyi çekme
$query = "SELECT * FROM hizmetler_genel";
...
if ($result->num_rows > 0) {
    while ($service = $result->fetch_assoc()) {
        ...
        echo '              <span class="heading-meta">' . $service['heading_meta'] . '</span>';
        echo '              <h2 class="doro-post-heading animate-box" data-animate-effect="fadeInLeft">' . $service['post_heading'] . '</h2>';
        echo '          </div>';
        echo '      </div>';
        echo '      <div class="row">';
        echo '          <div class="col-md-12 image-content animate-box fadeInLeft animated" data-animate-effect="fadeInLeft">';
        echo '              <img src="' . $service['main_image_src'] . '" class="img-fluid mb-30" alt="' . $service['post_heading'] . '">';
        echo '          </div>';
        echo '      </div>';
        echo '      <div class="row">';
        ...
        echo '                      <a href="' . $service['gallery_image_1'] . '" title="' . $service['post_heading'] . '" data-fslightbox class=" img-zoom">';
        echo '                          <div class="gallery-box">';
        echo '                              <div class="gallery-img">';
        echo '                                  <img src="' . $service['gallery_image_1'] . '" alt="thenewtheme.websitefabrikasi.com.tr" class="img-fluid mx-auto d-block" />';
        echo '                              </div>';
        echo '                          </div>';
        echo '                      </a>';
        echo '                  </div>';
        ...
        echo '              <div class="item">';
        echo '                  <div class="gallery-item-inner">';
        echo '                      <a href="' . $service['gallery_image_2'] . '" title="' . $service['post_heading'] . '" data-fslightbox class=" img-zoom">';
        echo '                          <div class="gallery-box">';
        echo '                              <div class="gallery-img">';
        echo '                                  <img src="' . $service['gallery_image_2'] . '" alt="thenewtheme.websitefabrikasi.com.tr" class="img-fluid mx-auto d-block" />';
        echo '                              </div>';
        echo '                          </div>';
        echo '                      </a>';
        echo '                  </div>';
...
?>
    ...
    <script src="../img/jss/lightbox_/fslightbox.js"></script>
...
<!-- Mirrored from thenewtheme.websitefabrikasi.com.tr/h/kurumsal-hizmetimiz-1-8408 by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 10 Nov 2022 17:31:11 GMT -->
</html>
