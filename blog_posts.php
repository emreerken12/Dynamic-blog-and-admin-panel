...
<meta name="description" content="BlogSayfa Açıklaması" /><meta name="keywords" content="Anasayfa Keywords" /></head>
...
// Veriyi çekme
$result = $conn->query("SELECT * FROM blog_posts_combined");
...
foreach ($posts as $post) {
    ...
    echo '                  <h2 class="doro-post-heading animate-box" data-animate-effect="fadeInLeft">' . $post['title'] . '</h2>';
    echo '              </div>';
    echo '          </div>';
    echo '          <div class="row">';
    echo '              <div class="col-md-12 image-content animate-box fadeInLeft animated" data-animate-effect="fadeInLeft">';
    echo '                  <img style="width: 700px; height: auto;" src="./admin_panel/dark/posts/'. $post['image_src'] . '" class="img-fluid mb-30" alt="' . $post['title'] . '">';
    echo '              </div>';
    echo '          </div>';
    echo '          <div class="row">';
