...
<!-- Mirrored from thenewtheme.websitefabrikasi.com.tr/blog by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 10 Nov 2022 17:31:00 GMT -->
...
<meta name="description" content="Blog Listesi" /><meta name="keywords" content="Blog Listesi" /></head>
...
<!-- navbar end -->
   ...
   $sql = "SELECT * FROM blog_posts_combined";
   ...
   if ($result->num_rows > 0) {
       echo '<div class="doro-blog">
               <div class="container-fluid">
                   <div class="row">
                       <div class="col-md-12">
                           <span class="heading-meta">Haberler</span>
                           <h2 class="doro-heading animate-box" data-animate-effect="fadeInLeft">Blog</h2>
                       </div>
                   </div>
                   <div class="row">';
           ...
           echo '<div class="col-md-6 col-sm-12">
                   <div class="blog-entry animate-box" data-animate-effect="fadeInLeft">
                       <a href="' . $row["detail_url"] . '" class="blog-img">
                        <img style="max_width: 400px; min_width:auto; height: 400px;" src="./admin_panel/dark/posts/'. $row["image_src"] . '" alt="' . $row["image_alt"] . '" class="img-fluid" />
   
                       </a>
                       <div class="desc" style="padding-left:5px;">
                           <span>' . date("d F Y", strtotime($row["publish_date"])) . ' |  <a href="blog/' . strtolower($row["category"]) . '.html">' . $row["category"] . '</a></span>
                           <h3><a href="' . $row["detail_url"] . '">' . $row["title"] . '</a></h3>
                           <p>' . $row["description"] . '</p>
                           <p><a href="' . $row["detail_url"] . '" class="lead">Devamını Oku <i class="ti-shift-right-alt"></i></a></p>
                       </div>
                   </div>
                 </div>';
       }
...
<!-- Mirrored from thenewtheme.websitefabrikasi.com.tr/blog by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 10 Nov 2022 17:31:03 GMT -->
</html>
