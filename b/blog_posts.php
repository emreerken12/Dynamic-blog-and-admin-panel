...
<!-- Mirrored from thenewtheme.websitefabrikasi.com.tr/b/eticaret-sitesi-nasil-kurulur-8302 by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 10 Nov 2022 17:31:17 GMT -->
...
<meta name="description" content="Eticaret sitesi nasıl kurulur?" /><meta name="keywords" content="Eticaret sitesi nasıl kurulur?" /></head>
...
// Veriyi çekme
$result = $conn->query("SELECT * FROM blog_posts_news");

// Verileri bir diziye alma
$posts = [];
while ($row = $result->fetch_assoc()) {
    $posts[] = $row;
}

// Veriyi foreach ile görüntüleme
foreach ($posts as $post) {
    echo '<div id="doro-main">';
    echo '  <div class="doro-projects">';
    echo '      <div class="container-fluid">';
    echo '          <div class="row">';
    echo '              <div class="col-md-12">';
    echo '                  <span class="heading-meta">' . $post['heading_meta'] . '</span>';
    echo '                  <h2 class="doro-post-heading animate-box" data-animate-effect="fadeInLeft">' . $post['post_heading'] . '</h2>';
    echo '              </div>';
    echo '          </div>';
    echo '          <div class="row">';
    echo '              <div class="col-md-12 image-content animate-box fadeInLeft animated" data-animate-effect="fadeInLeft">';
    echo '                  <img style="width: 700px; height: auto;" src="' . $post['image_src'] . '" class="img-fluid mb-30" alt="' . $post['post_heading'] . '">';
    echo '              </div>';
    echo '          </div>';
    echo '          <div class="row">';
